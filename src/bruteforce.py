...
║   ╚═╝     ╚═╝╚═╝   ╚══╝  ╚═╝      ╚═════╝  ╚═════╝ ╚═╝  ╚═╝║
║                                                              ║
║  ✅  PIN BERHASIL DITEMUKAN!                                  ║
║                                                              ║
╠══════════════════════════════════════════════════════════════╣
║                                                              ║
║   🔓  PIN : {YELLOW}{pin:<50}{GREEN}║
║                                                              ║
║   📊  Index        : {str(index):<41}{GREEN}║
║   📊  Total PIN    : {str(total):<41}{GREEN}║
║   📊  Total Dicoba : {str(total_tried):<41}{GREEN}║
║                                                              ║
╠══════════════════════════════════════════════════════════════╣
║                                                              ║
║   {YELLOW}{bar}{GREEN}  ║
║                                                              ║
║   Simpan PIN ini! Jangan sampai lupa.                        ║
║                                                              ║
╚══════════════════════════════════════════════════════════════╝
{RESET}"""
    print(msg)
    # Cetak juga ke stdout secara plain agar mudah dicopy
    print(f"{GREEN}{BOLD}[✅ PIN DITEMUKAN] ➜  PIN = {YELLOW}{pin}{RESET}")
...
class BruteforceEngine:
    ...
    def run(self):
        ...
        if self._found and self._found_pin:
            ...
            print(f"\n{GREEN}{BOLD}[✅ SELESAI] PIN berhasil ditemukan: {YELLOW}{self._found_pin}{RESET}\n")
